...
const Footer = () => (
  <footer className="flex flex-col justify-center items-center gap-[10px] w-full px-4 md:px-12 lg:px-[100px] pb-[70px] bg-white">
          ...
          <div className="flex flex-col items-start gap-[40px] w-full">
            <div className="flex justify-center items-center gap-[5px]">
              <Image
                ...
                alt="Sambandha logo"
                width={44} // Increased from 27 to 44
                height={44} // Increased from 27 to 44
                className="w-[44px] h-[44px]" // Increased from w-[27px] h-[27px]
              />
