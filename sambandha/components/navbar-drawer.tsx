...
const NavbarDrawer: NextPage<NavbarDrawerType> = ({
  className = "",
  onClose,
}) => {
  ...
  return (
    <div
      className={`w-[480px] relative bg-[#e3f0ea] overflow-hidden flex flex-col items-center justify-start pt-[15px] px-[10px] pb-[39px] box-border gap-[10px] [&.animate]:animate-[0.25s_ease_0s_1_normal_forwards_slide-in-right] opacity-[0] h-full max-w-[90%] text-left text-[16px] text-[#151313] font-[Jost] ${className}`}
      data-animate-on-scroll
    >
      <div
        onClick={() => {
      ...
      <div className="self-stretch border-[rgba(0,0,0,0.05)] border-solid border-b-[1px] flex flex-col items-center justify-center pt-[10px] pb-[30px] pl-[10px] pr-[0px] gap-[25px] md:flex">
        <button
          className="cursor-pointer [border:none] p-[0px] bg-[transparent] self-stretch flex flex-row items-center justify-start"
          onClick={onFrameButtonClick}
        >
          <div className="flex-1 flex flex-row items-center justify-start">
            <div className="flex-1 relative text-[16px] font-['Reckless_Neue'] text-[#151313] text-left sm:block">
              Home
            </div>
          </div>
        </button>
        <button className="cursor-pointer [border:none] p-[0px] bg-[transparent] self-stretch flex flex-row items-center justify-start">
          <div className="flex-1 flex flex-row items-center justify-start">
            <div className="flex-1 relative text-[16px] font-['Reckless_Neue'] text-[#151313] text-left">
              Products
            </div>
          </div>
        </button>
            ...
            >
              ...
              <div>
                ...
                <div className="rounded-3xs border-gray-300 border-[1px] border-solid box-border h-[41px] flex flex-row items-center justify-center p-2.5 gap-[25px] text-smi">
                  <button
                    className="cursor-pointer bg-transparent text-lg font-poppins text-black w-[20px] border-r-[1px] border-gray-300 pr-2"
