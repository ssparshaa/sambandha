    ...
    <div className="min-h-screen w-full max-w-[1440px] mx-auto flex flex-col items-start bg-white">
      ...
      <nav className="flex justify-between items-center w-full px-4 md:px-12 lg:px-[50px] py-[25px] bg-white">
        ...
        <div className="hidden md:flex items-start gap-[50px]">
          <div className="text-[#2d2d2d] font-epilogue text-[17px] font-normal leading-[28px] cursor-pointer hover:opacity-70 transition-opacity">
            Products
          </div>
          <div className="text-[#2d2d2d] font-epilogue text-[17px] font-normal leading-[28px] cursor-pointer hover:opacity-70 transition-opacity">
            About
      ...
      {isMenuOpen && (
        <div className="md:hidden w-full bg-white px-4 py-4 border-t border-gray-200">
          <div className="flex flex-col gap-4">
            <div className="text-[#2d2d2d] font-epilogue text-[17px] font-normal leading-[28px] cursor-pointer">Products</div>
            <div className="text-[#2d2d2d] font-epilogue text-[17px] font-normal leading-[28px] cursor-pointer">About</div>
            <div className="text-[#2d2d2d] font-epilogue text-[17px] font-normal leading-[28px] cursor-pointer">Contact</div>
            <div className="text-[#2d2d2d] font-epilogue text-[17px] font-normal leading-[28px] cursor-pointer">Sign In</div>
          </div>
        </div>
      )}
              ...
              <div className="flex flex-col justify-center items-center gap-[56px] w-full">
                ...
                <div className="flex flex-col justify-center items-center gap-[19px] w-full">
                  ...
                  <div className="w-full text-[#2d2d2d] text-center font-epilogue text-[15px] md:text-[17px] font-normal leading-[22px] md:leading-[27px]">
                    Login to upload photos, notes, voice clips, and dates — all in one place.
                  </div>
                </div>
              </div>
            </div>
