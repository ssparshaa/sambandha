    ...
    <div className="min-h-screen w-full max-w-[1440px] mx-auto flex flex-col items-start bg-white">
      ...
      <nav className="flex justify-between items-center w-full px-4 md:px-12 lg:px-[50px] py-[25px] bg-white">
        <div className="flex justify-center items-center gap-[5px]">
          ...
          />
          <div className="text-[#2d2d2d] font-bold text-[20px] leading-[30px]">
            Sambandha
          </div>
        </div>
        
        <div className="hidden md:flex items-start gap-[50px]">
          <div className="text-[#2d2d2d] text-[17px] font-normal leading-[28px] cursor-pointer hover:opacity-70 transition-opacity">
            Products
          </div>
          <div className="text-[#2d2d2d] text-[17px] font-normal leading-[28px] cursor-pointer hover:opacity-70 transition-opacity">
            About
      ...
      {isMenuOpen && (
        <div className="md:hidden w-full bg-white px-4 py-4 border-t border-gray-200">
          <div className="flex flex-col gap-4">
            <div className="text-[#2d2d2d] text-[17px] font-normal leading-[28px] cursor-pointer">Products</div>
            <div className="text-[#2d2d2d] text-[17px] font-normal leading-[28px] cursor-pointer">About</div>
            <div className="text-[#2d2d2d] text-[17px] font-normal leading-[28px] cursor-pointer">Contact</div>
            <div className="text-[#2d2d2d] text-[17px] font-normal leading-[28px] cursor-pointer">Sign In</div>
          </div>
        </div>
      )}
